...
func NewExtension(ctx *pulumi.Context,
	...
	s, err := ctx.RegisterResource("postgresql:extension/extension:Extension", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
...
func GetExtension(ctx *pulumi.Context,
	...
	s, err := ctx.ReadResource("postgresql:extension/extension:Extension", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &Extension{s: s}, nil
