...
class Role(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, bypass_row_level_security=None, connection_limit=None, create_database=None, create_role=None, encrypted=None, encrypted_password=None, inherit=None, login=None, name=None, password=None, replication=None, skip_drop_role=None, skip_reassign_owned=None, superuser=None, valid_until=None, __name__=None, __opts__=None):
        """
